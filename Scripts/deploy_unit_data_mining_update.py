...
config.set_editor_property("factory_maneuver_speed_centimeters_per_second",300.0)
...
# Project-copy particle sizes are world centimetres. Keep final values on reauthoring.
for suffix,before,target in [('Min',(5.,8.),(1.,1.6)),('Max',(1.5,20.),(.3,4.))]:
    assert unreal.GuLiScaleMigrationLibrary.set_mining_sprite_size020('Spark','ParticleSpawn',
        'Constants.Spark.InitializeParticle.Sprite Size '+suffix,
        unreal.Vector2D(*before),unreal.Vector2D(*target)),suffix
...
report={"success":width==5.0,"laser_width_before_cm":25.0,"laser_width_after_cm":width,"laser_width_multiplier":0.2,
