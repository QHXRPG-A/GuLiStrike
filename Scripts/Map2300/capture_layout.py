...
def main():
    out=Path(unreal.Paths.project_dir()).resolve()/'Artifacts/Map2300/20260923/views'
    ...
    assembly=ground(0,72500)
    central=ground(0,0)
    camera=unreal.EditorLevelLibrary.spawn_actor_from_class(unreal.SceneCapture2D,unreal.Vector(0,0,350000),transient=True)
    assert camera
    ...
    try:
        ...
        cases=[('overview',unreal.Vector(0,0,350000),unreal.Vector(),60),
               ('central_ramps',ground(32000,35000)+unreal.Vector(0,0,18000),central,60),
               ('ground_north_ramp',ground(0,35000)+unreal.Vector(0,0,450),central+unreal.Vector(0,0,250),60),
