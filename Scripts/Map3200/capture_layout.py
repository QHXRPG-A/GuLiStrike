...
def main():
    out=Path(unreal.Paths.project_dir()).resolve()/'Artifacts/Map3200/20260923/views'
    ...
    try:
        ...
        cases=[('overview',unreal.Vector(0,0,500000),unreal.Vector(),60),
               ('central_ramps',ground(48000,52000)+unreal.Vector(0,0,18000),central,60),
               ('ground_north_ramp',ground(0,52000)+unreal.Vector(0,0,450),central+unreal.Vector(0,0,250),60),
