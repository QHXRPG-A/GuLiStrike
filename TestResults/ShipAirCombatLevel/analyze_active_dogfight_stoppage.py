...
rows = [
    json.loads(line)
    for line in (root / "active_dogfight_stoppage_timeseries.jsonl")
...
report = {
    "schema": "guli.wingman.active-dogfight-stoppage.v1",
...
(root / "active_dogfight_stoppage_analysis.json").write_text(
