...
namespace GuLiCommanderStateTreeAssets
{
	...
	bool Build(const FTreeSpec& Spec)
	{
        ...
        {
            Add(TEXT("ReserveConstructionPosition"), Active | Started | Construction, Blocked, Step::ConstructionReserve, Phase::ConstructionPrepared, Result::None);
            Add(TEXT("WaitForConstructionPosition"), Active | Started | Construction, Blocked, Step::ConstructionReserve, Phase::ConstructionWaitingPosition, Result::WaitingPosition);
            Add(TEXT("MoveToConstructionSite"), Active | Started | Construction, Blocked, Step::ConstructionMove, Phase::ConstructionReserved, Result::TargetReady);
            ...
            Add(TEXT("BeginConstruction"), Active | Started | Construction, Blocked, Step::ConstructionWork, Phase::ConstructionMoving, Result::Arrived);
