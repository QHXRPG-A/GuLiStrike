...
private:
	...
	bool bRebuildAfterRemove = false;
};
...
DECLARE_MULTICAST_DELEGATE_TwoParams(FGuLiOreNodeChanged, uint32, uint8);
...
public:
	...
	void NotifyOreIndices(TConstArrayView<int32> Indices);
	FGuLiOreNodeChanged OreNodeChanged;
