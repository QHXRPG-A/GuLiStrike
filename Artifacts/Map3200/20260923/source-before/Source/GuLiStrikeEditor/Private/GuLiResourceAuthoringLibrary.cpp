...
namespace GuLiResourceAuthoring
{
	...
	{
		// The orthogonal roads connect the 49 fixed centers. Keep ore off their
		...
		const FVector2D Anchors[] = {
			FVector2D(0.0, GULI_RESOURCE_FACTORY_ANCHOR_Y_CM), FVector2D(0.0, GULI_RESOURCE_ASSEMBLY_ANCHOR_Y_CM),
			FVector2D(0.0, -GULI_RESOURCE_FACTORY_ANCHOR_Y_CM), FVector2D(0.0, -GULI_RESOURCE_ASSEMBLY_ANCHOR_Y_CM)
		};
