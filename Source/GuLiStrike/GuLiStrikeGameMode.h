...
#include "GuLiStrikeGameMode.generated.h"
 ...
 */
UCLASS(abstract)
class AGuLiStrikeGameMode : public AGameModeBase
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<UGuLiStrikeUI> UIWidgetClass;

	/** Pointer to the spawned UI Widget */
	TObjectPtr<UGuLiStrikeUI> UIWidget;
