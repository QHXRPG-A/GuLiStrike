...
#include "GuLiStrikeNPC.generated.h"

class AGuLiStrikePickup;
class AGuLiStrikeNPCDestruction;
 ...
 */
UCLASS(abstract)
class AGuLiStrikeNPC : public ACharacter
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<AGuLiStrikePickup> PickupClass;
