...
- 验证边界：本文按当前源码、数据表与既有测试静态核对；本轮只写文档，没有重新构建或运行 PIE。运行结论引用[既有实现归档](../../../Archive/20260901-指挥官选兵移动导航与小兵GAS扫射总归档-0831至0901.md)，不把历史结果写成本轮实测。
...
- [实现与验证归档](../../../Archive/20260901-指挥官选兵移动导航与小兵GAS扫射总归档-0831至0901.md)
